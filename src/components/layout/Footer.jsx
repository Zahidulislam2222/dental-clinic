      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          ...
          <div className="flex gap-6">
            <span className="hover:text-teal cursor-pointer transition-colors">{t({ en: 'Privacy Policy', bn: 'গোপনীয়তা নীতি' })}</span>
            <span className="hover:text-teal cursor-pointer transition-colors">{t({ en: 'Terms & Conditions', bn: 'শর্তাবলী' })}</span>
            <span className="hover:text-teal cursor-pointer transition-colors">{t({ en: 'Sitemap', bn: 'সাইটম্যাপ' })}</span>
          </div>
        </div>
      </div>
    </footer>
